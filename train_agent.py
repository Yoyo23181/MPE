...
def weights_changed(old_weights, new_weights):
...
for episode in tqdm(range(n_episodes)):
    ...
    while not done and step_count < max_steps_per_episode:
        ...
        old_actor_weights = get_weights(agent.actor)
        old_critic_weights = get_weights(agent.critic)
        ...
        new_actor_weights = get_weights(agent.actor)
        new_critic_weights = get_weights(agent.critic)

        print("Actor weights changed:", weights_changed(old_actor_weights, new_actor_weights))
        print("Critic weights changed:", weights_changed(old_critic_weights, new_critic_weights))
